# Generated by Django 5.1 on 2024-09-20 09:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='state', to='core.country', verbose_name='country')),
            ],
            options={
                'verbose_name': 'State',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', models.ManyToManyField(related_name='address', to='core.country', verbose_name='country')),
                ('state', models.ManyToManyField(to='core.state', verbose_name='state')),
            ],
            options={
