...
const Toast = ({ message,type, visible, onClose}) => {
    ...
    return (
        ...
        ${type === 'error' ? 'bg-reed-500 rext-white' : 'bg-green-500 text-white'}`}>
            <p>{message}</p>
        </div>
//         <main x-data="app" className="min-w-screen grid min-h-screen place-items-center">
//   <div id="toast-warning" className="fixed right-4 top-4 z-50 items-center w-full max-w-xs p-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
